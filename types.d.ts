...
declare const networking: typeof import("networking");
declare const messaging: typeof import("messaging");
declare const config: typeof import("config");
declare const im: typeof import("interface-manager");
declare const ipc: typeof import("ipc");
declare const javaInterface: typeof import("java-interfaces");
...
declare function findClass(
  className: string,
  useModClassLoader?: boolean
): Class<any> | undefined;
declare function setField(
  instance: any,
  fieldName: string,
  value: any | undefined
): void;
...
declare module "hooker" {
  ...
  function findConstructorParameters(
    className: string,
    types: string[]
  ): any | undefined;

  function hook(method: any, stage: stage, callback: HookCallback): HookUnhook;
  function hookAllMethods(
    clazz: Class<any>,
    methodName: string,
    stage: stage,
    callback: HookCallback
  ): HookUnhook;
  function hookAllConstructors(
    clazz: Class<any>,
    stage: stage,
    callback: HookCallback
  ): HookUnhook;
...
declare module "messaging" {
  ...
  type MessageUpdate =
    ...
    | "reaction"
    | "remove_reaction"
    | "revoke_transcription"
    | "allow_transcription"
    | "erase_saved_story_media";
  ...
  function fetchConversationWithMessagesPaginated(
    conversationId: string,
    lastMessageId: number,
    amount: number,
    callback: MessageListResultCallback
  ): void;
  function fetchConversationWithMessages(
    conversationId: string,
    callback: MessageListResultCallback
  ): void;
  function fetchMessageByServerId(
    conversationId: string,
    serverId: number,
    callback: MessageResultCallback
  ): void;
  function fetchMessagesByServerIds(
    conversationId: string,
    serverIds: number[],
    callback: MessageListResultCallback
  ): void;
  ...
  function getOneOnOneConversationIds(
    userIds: string[],
...
declare module "networking" {
  interface RequestBuilder {
    ...
    method(
      ...
      body: string | any
    ): RequestBuilder; // byte[] | java.io.InputStream
  }
